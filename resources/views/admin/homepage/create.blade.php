...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('homepage_title', old('homepage_title'), array('class'=>'form-control')) !!}

    </div>
</div><div class="form-group">
    {!! Form::label('homepage_description', 'Текст', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::textarea('homepage_description', old('homepage_description'), array('class'=>'form-control ckeditor')) !!}
