...
{!! Form::model($privacy, array('class' => 'form-horizontal', 'id' => 'form-with-validation', 'method' => 'PATCH', 'route' => array(config('quickadmin.route').'.privacy.update', $privacy->id))) !!}
...
<div class="form-group">
    <div class="col-sm-10 col-sm-offset-2">
      ...
      {!! link_to_route(config('quickadmin.route').'.privacy.index', trans('quickadmin::templates.templates-view_edit-cancel'), null, array('class' => 'btn btn-default')) !!}
    </div>
</div>
